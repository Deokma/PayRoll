...
public class AboutProgramDialog extends JDialog {
    ...
    public AboutProgramDialog(JFrame parent) {
        ...
        JTextArea txaInfo = new JTextArea(
                "Программа \"Расчет начисления платы за дни временной нетрудоспособности\" - это эффективное решение для расчета начисления за выплаты пособий в случае временной нетрудоспособности работников.\n" +
                        "\n" +
                        "Эта программа оснащена всеми необходимым для расчета пособий в соответствии с законодательством Республики Беларусь. Она позволяет легко вводить данные о начислениях и сохранять результаты расчета в базе данных. Благодаря этому вы можете легко отслеживать и анализировать историю начислений.\n" +
                        "\n" +
                        "Программа генерирует отчеты о начислениях, которые можно сохранять в различных форматах, таких как Word, Excel или PDF, и легко экспортировать для дальнейшей работы.\n" +
                        "\n" +
                        "С помощью этой программы вы сможете точно рассчитать начисления платы за дни временной нетрудоспособности, что ваша компания выплачивает своим сотрудникам все соответствующие пособия, сокращая риски ошибок и конфликтов.\n"
        );
