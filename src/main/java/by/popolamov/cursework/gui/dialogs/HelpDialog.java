...
public class HelpDialog extends JDialog {
    public HelpDialog(JFrame parent) {
        ...
        JTextArea txaHelpInfo = new JTextArea("Добро пожаловать в окно Help программы \"Расчёт начисления платы за дни временной нетрудоспособности\"!\n" +
                "\n" +
                "Эта программа позволяет автоматически рассчитывать начисление платы работникам за дни временной нетрудоспособности. Для начала расчёта нужно нажать на кнопку \"Добавить\" в главном окне, после чего ввести данные работника: ФИО и период болезни. После заполнения этой информации необходимо нажать кнопку \"Подтвердить\", чтобы продолжить расчёт.\n" +
                "\n" +
                "Далее программа запросит у пользователя данные о зарплате работника за предыдущие 6 месяцев и количество дней нетрудоспособности, если таковые имеются. Если пользователь не заполнит все поля, и нажмёт кнопку \"Расчёт\", программа автоматически заполнит их нулями.\n" +
                "\n" +
                "Расчёт начисления платы происходит после нажатия на кнопку \"Расчёт\", и выводится в том же окне. В случае необходимости, пользователь может сохранить данные о расчёте, используя кнопку \"Сохранить\".\n" +
                "\n" +
                "Кроме того, в главном окне пользователь может просмотреть детали расчёта, такие как количество дней, сумму начисления и другие параметры. Это может быть полезно для того, чтобы убедиться в правильности расчёта или для отчётности перед работодателем или страховой компанией.\n" +
                "\n" +
