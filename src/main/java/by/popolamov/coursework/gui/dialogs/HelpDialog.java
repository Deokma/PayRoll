...
public class HelpDialog extends JDialog {
    public HelpDialog(JFrame parent) {
        ...
        JTextArea txaHelpInfo = new JTextArea(
                "Добро пожаловать в окно Help программы " +
                        "\"Расчёт начисления платы за дни временной нетрудоспособности\"!\n" +
                        "\n" +
                        "Эта программа позволяет автоматически рассчитывать начисление платы работникам " +
                        "за дни временной нетрудоспособности." +
                        " Для начала расчёта нужно нажать на кнопку \"Добавить\" в главном окне, " +
                        "после чего ввести данные работника:" +
                        " ФИО и период болезни. После заполнения этой информации необходимо " +
                        "нажать кнопку \"Подтвердить\"," +
                        " чтобы продолжить расчёт.\n" +
                        "\n" +
                        "Далее программа запросит у пользователя данные о зарплате работника " +
                        "за предыдущие 6 месяцев и количество" +
                        ...
                        "\n" +
                        "Расчёт начисления платы происходит после нажатия на кнопку \"Расчёт\", " +
                        "и выводится в том же окне." +
                        " В случае необходимости, пользователь может сохранить данные о расчёте, " +
                        "используя кнопку \"Сохранить\".\n" +
                        "\n" +
                        "Кроме того, в главном окне пользователь может просмотреть детали расчёта, " +
                        "такие как количество дней," +
                        " сумму начисления и другие параметры. Это может быть полезно для того, " +
                        "чтобы убедиться в правильности" +
                        " расчёта или для отчётности перед работодателем или страховой компанией.\n" +
                        "\n" +
                        "Также программа позволяет сохранить результаты расчёта в файлы " +
                        "Word, Excel или PDF, что удобно для архивирования данных," +
                        " печати или отправки по электронной почте. Все файлы сохраняются " +
                        "в выбранной пользователем директории и могут" +
                        " быть легко найдены и открыты в дальнейшем. \n" +
                        "\n" +
                        "Также в программе есть возможность поменять базу данных, в " +
                        "которой хранятся данные о работниках и начислениях." +
                        " Для этого откройте файл \"database.properties\" который " +
                        "находится в директории \"src\\main\\resources\"" +
                        " и измените настройки под свои нужды. " +
                        "Обратите внимание, что изменение базы данных может привести " +
                        "к потере всех ранее сохраненных данных." +
